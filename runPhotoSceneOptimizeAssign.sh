...
bash script_optMatGAN.sh $sceneId $gpuId "cluster" $modeName $modeId false "$isDebug" AssignedGan
# bash script_optMatGAN.sh 0022_01 0 cluster statWeight 1 false true AssignedGan
python combineResultNew.py --sceneId $sceneId --modeName $modeName --modeId $modeId --isSelect --isGan --isDebug --machine cluster --debugTask AssignedGan
# python combineResultNew.py --sceneId 0022_01 --modeName statWeight --modeId 1 --isSelect --isGan --isDebug --machine cluster AssignedGan
### <<< Run MaterialGAN
...
bash script_optMatAll.sh $sceneId $gpuId "cluster" $modeName $modeId $matRes false false "$isDebug" "$runDebugInvRender" AssignedMatch
# bash script_optMatAll.sh 0022_01 0 cluster statWeight 1 8 false false true false AssignedMatch
python combineResultNew.py --sceneId $sceneId --modeName $modeName --modeId $modeId --isSelect --isDebug --machine cluster --debugTask AssignedMatch
# python combineResultNew.py --sceneId 0022_01 --modeName statWeight --modeId 1 --isSelect --isDebug --machine cluster --debugTask AssignedMatch
### <<< Run MaTch
